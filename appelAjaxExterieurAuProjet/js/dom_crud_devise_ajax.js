...
function postNewDeviseWithAjax(nouvelleDevise){
    ...
    makeAjaxPostRequest( "http://localhost:8282/devise-api/private/devise" ,
...
function putNewValueOfExistingDeviseWithAjax(deviseToUpdate){
    makeAjaxPutRequest("http://localhost:8282/devise-api/private/devise" ,
...
function deleteOldDeviseWithAjax(oldDevise){
    ...
    //***************************************
    let deleteUrl= "http://localhost:8282/devise-api/private/devise/" + oldDevise.code
