  ...
  return new Promise( (resolve,reject)=>{
    ...
    ThisPersistentModel.deleteMany( deleteAllFilter)
      .then(()=>{ //insert elements after deleting olds
        (new ThisPersistentModel({ username : "user1" , password : "pwd1" , roles : "user"})).save();
        (new ThisPersistentModel({ username : "user2" , password : "pwd2" , roles : "user"})).save();
        (new ThisPersistentModel({ username : "admin1" , password : "pwd1" , roles : "admin,user"})).save();
        (new ThisPersistentModel({ username : "admin2" , password : "pwd2" , roles : "admin"})).save();
