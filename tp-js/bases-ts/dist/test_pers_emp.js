...
const employes_1 = require("./employes");
...
class MyApp {
    static main() {
        ...
        let p2 = new personnes_1.Personne(2, "jean", "Bon", 45);
        ...
        let persJsonString = '{ "numero":2 , "nom" : "titi" , "prenom" : null } ';
        ...
        function affPerson(p) {
            var _a;
            console.log("**** p compatible IPerson avec  nom=" + p.nom + " , numero=" + p.numero + " , prenom =" + ((_a = p.prenom) === null || _a === void 0 ? void 0 : _a.toUpperCase()));
        }
